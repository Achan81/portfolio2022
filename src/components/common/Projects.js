function Projects() {
  return (
    ...
    <section className="mt-50" id="projects">
      ...
      <div className="fs-6 mb-0 fst-italic">
      ...
      <div className="text-uppercase fs-6 mb-0 fw-bold">space invaders | solo project | 7 days</div>
      <div className="fs-6 mb-0">
      A grid based shoot em up game built in JavaScript, HTML & CSS.
      ...
      I would very much like to revisit and improve the game further.
      </div>
      <hr></hr>

      <div className="text-uppercase fs-6 mb-0 fw-bold">heros & villains db | pair project | 48 hours hackathon</div>
      <div className="fs-6 mb-0">
      As a pair, we built a React.js app which used an external Superhero-API (Multiple universes superheroes open-source REST API). 
      ...
      The app functions as a database for searching and filtering from a variety of heroes/villains from various publishers to see and compare stats. 
      </div>
      <hr></hr>

      <div className="text-uppercase fs-6 mb-0 fw-bold">placebook | group project | 7 days</div>
      <div className="fs-6 mb-0">
      ...
      CSS framework used on this project was Bootstrap and part React Bootstrap.
      </div>
      <hr></hr>

      <div className="text-uppercase fs-6 mb-0 fw-bold">pawhub | group project | 7 days</div>
      <div className="fs-6 mb-0">Full-Stack MERN app with CRUD functionality using Python, Django API and SQL database, with React.js & TailwindCSS. 
      ...
      CSS framework used on this project was Tailwind.
      </div>
      <hr></hr>
