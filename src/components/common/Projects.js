      ...
      <div data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
        ...
        <Collapse in={open4}>
          <div id="collapse-text4" className="content fw-lighter">
            <p className="hidden-text bgClip bgClip">Full-Stack MERN app with CRUD functionality using Python, Django API and SQL database, with React.js & TailwindCSS. As a group, we made a clone app of the Dogs Trust website (renamed as Pawhub). Aside from styling the site closely to its original, its key features mirrored things we learnt over the course, such as secure registration & log in, presenting dog index and search functionality, show pages. Collectively, we completed the Back End and seeded a database together. On the Front End, we each had pages to build, my main contributions were the questionnaire forms and the donation page. CSS framework used on this project was Tailwind 3.0.</p>
            <div className="container">
              <div className="d-flex flex-row justify-content-center mt-n20">
