  ...
  return (
    ...
    <div className="mt-50 blurry-text" id="projects">
      <div data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
        <div className="bgClip title text-uppercase mb-0 fw-bold opacity-75">projects</div>
        <hr className="bg-dark border-5 border-top border-dark"></hr>
        <div className="bgClip fs-6 mb-0 fw-bold opacity-75">General Assembly - Software Engineering Immersive Course:</div>
        <div className="bgClip fs-6 mb-0 mt-n20 opacity-75">London UK (Remote) - NOV 2021 - FEB 2022</div>
        <div className="bgClip fw-normal fs-6 mb-0 fst-italic mt-n20 opacity-75">
        ...
        <a
          className="project-title fs-5 text-decoration-none bg-transparent text-uppercase text-dark border-none btn-outline-dark opacity-75 fw-bold"
        ...
        <a
          ...
          aria-expanded={open2}
          className="project-title fs-5 text-decoration-none bg-transparent text-uppercase text-dark border-none btn-outline-dark fw-bold opacity-75"
