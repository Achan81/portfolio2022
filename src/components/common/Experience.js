function Experience() {
  return (
    ...
    <section className="blurry-text opacity-75" id="experience">
      ...
      <div className="text-uppercase fs-5 fw-bold">Senior Designer - The 1922 Clothing Company Ltd (2009 - 2014)</div>
      <ul className="fw-lighter exp fs-6 mb-0">
      ...
      <div className="text-uppercase fs-5 fw-bold">Designer - The 1922 Clothing Company Ltd (2007 - 2009)</div>
      <ul className="fw-lighter exp fs-6 mb-0">
      ...
      <div className="text-uppercase fs-5 fw-bold">Fashion Graphic Designer  - Focus Brands (2005 - 2007)</div>
      <ul className="fw-lighter exp fs-6 mb-0">
      ...
      <div className="text-uppercase fs-5 fw-bold"> Freelance Graphic Designer (2004 - 2005)</div>
      <ul className="fw-lighter exp fs-6 mb-0">
        ...
        <li>- company brand for local business clients focusing on traditional graphic design.</li>
        <li>- events flyers / banners graphics.</li>
      </ul>
      <hr className="bg-dark border-5 border-top border-dark"></hr>
